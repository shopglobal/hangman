var wordLists = { 
  ...
  "tech": ["computer", "android", "iphone", "mac", "pc", "console.log", "windows", "linux", "unix", "cpanel", "mysql", "nodejs", "github", "stackoverflow", "skype", "slack", "array", "frontend", "backend", "wordpress", "cms", "div", "header", "body", "footer", "paragraph", "text", "python", "ruby", "platform", "saas", "string", "function", "object", "method", "callback", "property", "prototype", "jquery", "language", "programming", "primatives", "syntax", "variable", "variables", "alert", "alerts", "prompt", "prompts", "boolean", "strings", "string", "dom", "console", "log", "math", "automation", "javascript", "react", "node", "html", "css", "class", "id", "minified"],
 };
